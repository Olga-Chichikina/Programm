...
if (arg < 1000 )   Console.WriteLine("Третья  цифра этого числа :  " + arg % 10 );

if ( arg >= 1000) 
   if (arg < 10000 ) Console.WriteLine("Третья  цифра этого числа :  " + arg % 100 / 10); 
if ( arg >= 10000 )
   if ( arg < 1000000000) Console.WriteLine("Третья  цифра этого числа :  " + arg % 1000 / 100 ); 

//if ( arg >= 100000 )
//   if ( arg < 1000000) Console.WriteLine("Третья  цифра этого числа :  " + arg % 1000 / 100 );
//
//if ( arg >= 1000000 )
//   if ( arg < 10000000) Console.WriteLine("Третья  цифра этого числа :  " + arg % 1000 / 100 );
//
//if ( arg >= 10000000 )
//   if ( arg < 100000000) Console.WriteLine("Третья  цифра этого числа :  " + arg % 1000 / 100 );
//
//if ( arg >= 100000000 )
//   if ( arg < 1000000000) Console.WriteLine("Третья  цифра этого числа :  " + arg % 1000 / 100 );
}
